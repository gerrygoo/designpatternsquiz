...
- <b>Microservices</b>: The _Patterns_ _Quiz_ application consumes microservices implemented and hosted in AWS Lambdas to present the questions and keep track of the
